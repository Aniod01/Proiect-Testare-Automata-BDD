...
class LoginPage(BasePage):
    ...
    def check_login_link(self, user):
        WebDriverWait(self.driver, 3).until(EC.presence_of_element_located((By.XPATH, f'//a[contains(text(),"{user}")]')))
        assert self.driver.find_element(By.XPATH, f'//a[contains(text(), "{user}")]').is_displayed(), "I am not in my account page"
